...
dichiarano interessati a un determinato topic svincolando il mittente
dal conoscere la posizione dei destinatari. Per questi motivi
...
query: la routine associata alla ricezione di questo messaggio
in un \emph{DSRobot} crea un attore figlio \emph{DSQueryChecker}.
